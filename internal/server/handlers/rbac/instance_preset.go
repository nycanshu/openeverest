...
// CreateInstancePreset creates a new instance preset, gated by RBAC.
...
// UpdateInstancePreset updates an existing instance preset, gated by RBAC.
...
// CreateInstancePresetFromInstance creates a preset from an existing instance, gated by RBAC.
func (h *rbacHandler) CreateInstancePresetFromInstance(ctx context.Context, cluster, namespace, instanceName, presetName string) (*corev1alpha1.InstancePreset, error) {
	// Check read permission on the source instance
	...
	// Check create permission on instance presets
